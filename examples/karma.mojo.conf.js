...
var config = loadKarmaConfig(require('./karma.conf.js'));
var mojoRunner = process.env.MOJO_RUNNER_PATH;
...
// test files!
//
config.files = [ 'my-app/boot-for-test.js', mojoRunner ]
...
config.mojo.pattern = [ 'my-app/**/__tests__/*.test.js' ];
...
config.preprocessors['my-app/boot-for-test.js'] = [ 'webpack', 'sourcemap' ];
